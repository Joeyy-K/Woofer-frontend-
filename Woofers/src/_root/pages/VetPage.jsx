    ...
    <div className="container mx-auto ">
            <div className="flex flex-wrap mb-12">
                ...
                <div className="w-full md:w-1/2 border-r">
                  <div className="p-3 py-0 mb-4">
                    <div className="flex justify-between items-center mb-3">
                      <h4 className="text-right font-semibold">Your Veterinarian</h4>
                    </div>
                    <hr className="my-4 bg-gray-100 h-0.5"/>
                      ...
                      <div className="mb-5">
                        <div className="card">
                          <div className="card-body m-3">
                            <label className="block mb-3 text-x font-bold text-gray-900 dark:text-white">Reviews</label>
